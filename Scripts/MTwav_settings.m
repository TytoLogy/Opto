...
WavesToPlay = {
'1StepUSVMating - normalized+NR+filtered_adj.wav', ...
'2StepUSVMating - normalized+NR+filtered_adj.wav', ...
'ChevronMating - normalized+NR+filtered_adj.wav', ...
'ChevronwNLsMating - normalized+NR+filtered_adj.wav', ...
'FlatMating - normalized+NR+filtered_adj.wav', ...
'LFHMating2 - normalized+NR+filtered_adj.wav', ...
'MFVtonalRestraint - normalized+NR+filtered_adj.wav', ...
'MFVwHarmonicsRestraint - normalized+NR+filtered_adj.wav', ...
'MFVwNLsRestraint - normalized+NR+filtered_adj.wav', ...
'Noisy - normalized+NR+filtered_adj.wav', ...
'Flat-tone_adj.wav' ...
};
