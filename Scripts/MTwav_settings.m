...
WavesToPlay = {
'1StepUSVMating - normalized+NR+filtered.wav', ...
'2StepUSVMating - normalized+NR+filtered.wav', ...
'ChevronMating - normalized+NR+filtered.wav', ...
'ChevronwNLsMating - normalized+NR+filtered.wav', ...
'FlatMating - normalized+NR+filtered.wav', ...
'LFHMating2 - normalized+NR+filtered.wav', ...
'MFVtonalRestraint - normalized+NR+filtered.wav', ...
'MFVwHarmonicsRestraint - normalized+NR+filtered.wav', ...
'MFVwNLsRestraint - normalized+NR+filtered.wav', ...
'Noisy - normalized+NR+filtered.wav', ...
'Flat-tone.wav' ...
};
