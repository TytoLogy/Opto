function [matpath, matfile] = opto_createDataMatFileName(handles, test)
%--------------------------------------------------------------------------
% [matpath, matfile] =  opto_createDataMatFileName(handles)
%--------------------------------------------------------------------------
% opto program
%--------------------------------------------------------------------------
% 
% Generates output mat filename
% 
%--------------------------------------------------------------------------
% Input Arguments:
%
...
%--------------------------------------------------------------------------
% Revision History
%	13 Jun 2017 (SJS): file created from opto_createDataFileName
%--------------------------------------------------------------------------
...
defaultfile = sprintf('%s_%s_%s_%s_%s_%s.mat', ...
...
% check with user
[matfile, matpath] = uiputfile('*.dat', 'Save Data', defaultfile);