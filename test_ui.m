...
%      TEST_UI, by itself, creates a new TEST_UI or raises the existing
%      singleton*.
%
...
% Edit the above text to modify the response to help test_ui

% Last Modified by GUIDE v2.5 11-May-2016 18:46:40
